...
import com.aditya.dicoding.gamecatalog.core.databinding.ItemListGameBinding
...
class ListGameAdapter(
...
): RecyclerView.Adapter<ListGameAdapter.ListGameHolder>() {
    private lateinit var context: Context

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListGameHolder {
        context = parent.context
        val binding = ItemListGameBinding.inflate(LayoutInflater.from(context), parent, false)
    ...
    inner class ListGameHolder(var binding: ItemListGameBinding): ViewHolder(binding.root)
